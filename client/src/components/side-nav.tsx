...
import MenutItemFollow from "./menu-item-follow"
...
const Sidenav = () => {
  ...
  const displayedUsers = showAllUsers ? data?.getUsers : data?.getUsers.slice(0, 3) // Only show the first 3 users
  ...
  >
    <div className="lg:w-full w-[55px] mx-auto">
      ...
      <button onClick={() => setShowAllUsers(!showAllUsers)} className="lg:block hidden text-[#F02C56] pt-1.5 pl-2 text-[13px]">
        See more
      </button>
      <div className="border-b lg:ml-2 mt-2" />
      <div className="lg:block hidden text-xs text-gray-600 font-semibold pt-4 pb-2 px-2">
