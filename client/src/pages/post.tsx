...
import { GET_POST_BY_ID } from "../graphql/queries/get-post-by-id"
...
import { GET_COMMENTS_BY_POST_ID } from "../graphql/queries/get-comments-by-post-id"
...
function SinglePost() {
  ...
  const [deleteComment] = useMutation(DELETE_COMMENT, {
    update(cache, { data: { deleteComment } }) {
      ...
      const newComments = existingComments?.getCommentsByPostId.filter((comment) => comment.id !== deletedCommentId)
